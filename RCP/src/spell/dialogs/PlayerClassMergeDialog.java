...
public class PlayerClassMergeDialog extends TitleAreaDialog {

	private Combo itemCombo;
	private PlayerClass sourceItem;
	private int value;
	private PlayerClass[] items;
	private PlayerClass targetItem;
	...
	public PlayerClassMergeDialog(Shell parentShell, PlayerClass[] items, PlayerClass sourceItem) {
		super(parentShell);
	...
	public void create() {
		...
		setMessage(	LocaleManager.instance().getMessage("classNotFound") + "\n"+
					LocaleManager.instance().getMessage("class") + " : " + sourceItem.getTitle() , IMessageProvider.WARNING);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		radio.setText(LocaleManager.instance().getMessage("classCreate"));
		...
		radio.setText(LocaleManager.instance().getMessage("classLink"));
		radio.setData("LINK");
		radio.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent event) {
				value = LINK;
		...
		radio = new Button(group, SWT.RADIO | SWT.LEFT);
		radio.setText(LocaleManager.instance().getMessage("classIgnore"));
	...
	public PlayerClass getTargetItem() {
		return targetItem;
	}
