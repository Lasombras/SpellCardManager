...
public class SchoolMergeDialog extends TitleAreaDialog {

	private Combo itemCombo;
	private School sourceItem;
	private int value;
	private School[] items;
	private School targetItem;
	...
	public SchoolMergeDialog(Shell parentShell, School[] items, School sourceItem) {
		super(parentShell);
	...
	public void create() {
		...
		setMessage(	LocaleManager.instance().getMessage("schoolNotFound") + "\n" +
					LocaleManager.instance().getMessage("school") + " : " + sourceItem.getTitle(), IMessageProvider.WARNING);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		radio.setText(LocaleManager.instance().getMessage("schoolCreate"));
		...
		radio.setText(LocaleManager.instance().getMessage("schoolLink"));
		radio.setData("LINK");
		radio.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent event) {
				value = LINK;
		...
		radio = new Button(group, SWT.RADIO | SWT.LEFT);
		radio.setText(LocaleManager.instance().getMessage("schoolIgnore"));
