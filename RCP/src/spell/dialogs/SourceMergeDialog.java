...
public class SourceMergeDialog extends TitleAreaDialog {

	private Combo itemCombo;
	private Source sourceItem;
	private int value;
	private Source[] items;
	private Source targetItem;
	...
	public SourceMergeDialog(Shell parentShell, Source[] items, Source sourceItem) {
		super(parentShell);
	...
	public void create() {
		...
		setMessage(	LocaleManager.instance().getMessage("sourceNotFound") + "\n" +
					LocaleManager.instance().getMessage("sourceName") + " : " + sourceItem.getTitle(), IMessageProvider.WARNING);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		radio.setText(LocaleManager.instance().getMessage("sourceCreate"));
		...
		radio.setText(LocaleManager.instance().getMessage("sourceLink"));
		radio.setData("LINK");
		radio.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent event) {
				value = LINK;
		...
		radio = new Button(group, SWT.RADIO | SWT.LEFT);
		radio.setText(LocaleManager.instance().getMessage("sourceIgnore"));
