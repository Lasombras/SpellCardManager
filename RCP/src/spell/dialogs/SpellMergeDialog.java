...
public class SpellMergeDialog extends TitleAreaDialog {

	private Combo itemCombo;
	private Spell sourceItem;
	private int value;
	private Spell[] items;
	private Spell targetItem;
	...
	public SpellMergeDialog(Shell parentShell, Spell[] items, Spell sourceItem) {
		super(parentShell);
	...
	public void create() {
		...
		setMessage(	LocaleManager.instance().getMessage("spellNotFound") + "\n" +
					LocaleManager.instance().getMessage("spell") + " : " + sourceItem.getTitle(), IMessageProvider.WARNING);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		radio.setText(LocaleManager.instance().getMessage("spellCreate"));
		...
		radio.setText(LocaleManager.instance().getMessage("spellReplace"));
		...
		radio = new Button(group, SWT.RADIO | SWT.LEFT);
		radio.setText(LocaleManager.instance().getMessage("spellIgnore"));
